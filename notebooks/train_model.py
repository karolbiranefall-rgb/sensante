...
print(cm)
#Rapport d eclassification
print("\n Rapport de classifiaction:")
...
joblib.dump(feature_cols, "models/features_cols.pkl")
print("Encodeurs et metadata sauvegardes.")

#Simuler ce que fera l'API en Lab3:
# Charger le modele DEPUIS LE FICHIER (pas depuis la memoire)
model_loaded  = joblib.load("models/model.pkl")
le_sexe_loaded = joblib.load("models/encoder_sexe.pkl")
le_region_loaded = joblib.load("models/encoder_region.pkl")

print(f"Modele recharge : {type(model).__name__}")
