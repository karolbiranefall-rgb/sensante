...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],      # En dev : accepte toutes les sources (ex: localhost:3000)
...
@app.get("/model-info")
def get_model_info():
    """Renvoie les informations techniques du modèle chargé."""
    return {
...
def predict(patient: PatientInput):
    """Predire un diagnostic a partir des symptomes."""
